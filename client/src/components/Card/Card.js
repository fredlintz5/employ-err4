...
class Card extends Component {	
	...
	render () {
		const {toggle, href, image, pending, displayName, title, bio} = this.props;
		return (
			<a className="row displayCard" data-toggle={this.setToggle(toggle)} 
				...
				<div className="col-lg-4 text-center" style={{paddingLeft: "10px"}}>
					...
					<span id="thumbsUp"><i style={pending ? {display: "block"} : {display: "none"}} className="fa fa-thumbs-up" aria-hidden="false"></i></span>
				</div>
